...
public class M3Test extends TestCase {
    ...
    public void test03ReplicationAfterRemoveNode() throws Exception {
        ...
        ECSNode tmp = new ECSNode("server1", "localhost", 50000);

        hashRing.addNode(new ECSNode("server1", "localhost", 50000));
        hashRing.addNode(new ECSNode("server2", "localhost", 50001));
        hashRing.addNode(new ECSNode("server3", "localhost", 50002));
        hashRing.addNode(new ECSNode("server4", "localhost", 50003));
        hashRing.addNode(new ECSNode("server5", "localhost", 50004));
        hashRing.addNode(new ECSNode("server6", "localhost", 50005));

        Collection<ECSNode> replicas = hashRing.getReplicas(tmp);

        int cnt = 0;
        String key = "102381023814";
        String value = "bar";
